...
THREE.EditorControls = function ( object, domElement ) {
	...
	var STATE = { NONE: - 1, ROTATE: 4, ZOOM: 1, PAN: 2 };
	...
	this.pan = function ( delta ) {
		...
		/*if ((object.position.x > 15 && delta.x > 0) || (object.position.x < -15 && delta.x < 0)) {
			delta.x = 0;
		}
		if ((object.position.z > 15 && delta.z > 0) || (object.position.z < -15 && delta.z < 0)) {
			delta.z = 0; 
		}*/
	...
	this.zoom = function ( delta ) {
		...
		if ( (object.zoom - delta.z) < 0.5 || (object.zoom - delta.z) >= 15 ) return;
